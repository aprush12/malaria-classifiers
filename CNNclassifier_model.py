...
Original file is located at
    https://colab.research.google.com/drive/1koR4O0fWcV2L8Wcw4LMbIWaidZwDTzd5
"""
################################################################################
...
# For purposes of the project - find the distirbution of infected and uninfected images in the training and validation datasets
